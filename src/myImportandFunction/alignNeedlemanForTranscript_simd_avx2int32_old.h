...
class alignNeedlemanForTranscript_simd_avx2int32 {
    ...
    //    std::string _signs;
        ...
        int32_t _exon_open_gap_penalty;
        int32_t _exon_extend_gap_penalty;
        //std::map<char, <std::map<char, double> > _exon_subsitition_matrix;

        int32_t _intron_match_score;
        int32_t _intron_mismatch_score;
        int32_t _intron_open_gap_penalty;
        int32_t _intron_extend_gap_penalty;

        int32_t _start_stop_codon_match_score;
        int32_t _start_stop_codon_mismatch_score;
        int32_t _start_stop_codon_open_gap_penalty;
        int32_t _start_stop_codon_extend_gap_penalty;

        int32_t _splice_sites_match_score;
        int32_t _splice_sites_mismatch_score;
        int32_t _splice_sites_open_gap_penalty;
        int32_t _splice_sites_extend_gap_penalty;
